...
import { FaUndo, FaTrashAlt, FaList, FaToggleOn, FaToggleOff } from 'react-icons/fa';
    ...
    return (
        <div className="container mx-auto mt-8 px-4 font-mono">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-medium text-gray-700">Thùng rác - Người dùng</h1>
                <button
                    className="bg-blue-500 text-white px-4 py-2 rounded"
                    onClick={() => navigate('/admin/user')}
                >
                    <FaList className="inline mr-2" /> Quay lại danh sách
                </button>
            </div>
                    ...
                    <table className="min-w-full bg-white">
                        ...
                        <tbody className="divide-y divide-gray-200">
                            {trashedUsers.length > 0 ? (
                                ...
                                <tr>
                                    <td colSpan="7" className="text-center py-12 text-gray-500">Thùng rác trống</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
