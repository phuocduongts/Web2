...
function UserCreate() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await UserService.create(formData, profileImage);
            setSuccess(true);
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        <div className="space-y-1">
                            ...
                            <input
                                ...
                                className={`w-full px-3 py-2 border ${errors.username ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 font-mono text-sm`}
                                required
                            />
